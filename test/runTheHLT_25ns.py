# /users/hbrun/tests/reRunElectron26june/V3 (CMSSW_7_4_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/hbrun/tests/reRunElectron26june/V3')
)
...
process.hltPreEle12CaloIdLTrackIdLIsoVL = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltEle12CaloIdLTrackIdLIsoVLL1MatchFilter = cms.EDFilter( "HLTEgammaL1MatchFilterRegional",
...
process.HLT_Ele12_CaloIdL_TrackIdL_IsoVL_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG10 + process.hltPreEle12CaloIdLTrackIdLIsoVL + process.HLTEle12CaloIdLTrackIdLIsoVLSequence + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele12_CaloIdL_TrackIdL_IsoVL_v1, process.HLTriggerFinalPath ))
...
process.source = cms.Source( "PoolSource",
                            ...
                            secondaryFileNames = cms.untracked.vstring(
                                                                       'file:/tmp/hbrun/theRAWfile_0.root',
                                                                       'file:/tmp/hbrun/theRAWfile_1.root',
...
process.ElecIdTreeProducer = cms.EDAnalyzer('ElecIdTreeProducer',
                                            ...
                                            elecIdName                  = cms.VInputTag(cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-PHYS14-PU20bx25-V2-standalone-veto"),
                                            ...
                                            pathsToSave           =cms.vstring("HLT_Ele12_CaloIdL_TrackIdL_IsoVL_v"),
...
process.triggerResultsFilter.triggerConditions = cms.vstring("HLT_Ele12_CaloIdL_TrackIdL_IsoVL_v*")
...
process.rhoEtAl = cms.Path(process.kt6PFJetsForIsolation*process.egmGsfElectronIDSequence)
process.HLTSchedule.extend([process.rhoEtAl])
#process.p = cms.EndPath(process.kt6PFJetsForIsolation*process.egmGsfElectronIDSequence*process.ElecIdTreeProducer)
process.p = cms.EndPath(process.kt6PFJetsForIsolation*process.egmGsfElectronIDSequence*process.ElecIdTreeProducer)
...
_customInfo['globalTag' ]= "MCRUN2_74_V9"
